<html>
<body>
<form name="f1" align="center" action="facultyregistrationform.php" method="post">
...
if(isset($_POST['submit']))
{
	...
	$sql="insert into addfaculty(firstname,lastname,username,password,confirmpassword,postalcode,phonenumber,mailid) values('$firstname','$lastname','$username','$password','$confirmpassword','$postalcode','$phonenumber','$mailid');";
